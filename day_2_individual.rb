# Write a function that accepts an array of strings and returns a new array containing every other string from the original array. For paexample, if the input is ["a", "b", "c", "d", "e", "f"], the output should be ["a", "c", "e"].
